 ...
 */
const CustomToast = ({ show, onClose, message, variant="success", delay = 2000 }) => {
  return (
    <ToastContainer className="p-3" position="top-end">
      <Toast onClose={onClose} show={show} delay={delay} autohide bg={variant == "success" ? "success" : "danger"} >
